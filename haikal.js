...
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yoapk GalladeBotz*')
}
...
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yozip GalladeBotz*')
}
...
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yopdf GalladeBotz*')
}
...
case 'addprem':
if (!isCreator) return m.reply('*Khusus Owner Bot*')
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 628991341381`)
...
case 'pengguna':  {
if (!isCreator) return m.reply(`*khusus Premium*`)
if (!args[0]) return reply(`*Contoh : ${command} add 628991341381*`)
if (args[1]) {
...
reply(`Wait 1-24 Jam an untuk proses banned dari bot dan tunggu ±30 Detik an untuk melihat balasan email dari WhatsApp tuan Gallade🥺🙏`)
...
reply(`Wait 1-24 Jam an untuk proses unbanned dari bot dan tunggu ±30 Detik an untuk melihat balasan email dari WhatsApp tuan Gallade🥺🙏`)
await loading(90000)
let payload = String(res.data)
if (payload.includes(`"payload":true`)) {
reply(`##- WhatsApp Support -##
...
"sellerJid": "628991341381@s.whatsapp.net",
...
if (args[0].startsWith(`+628991341381`)) return reply('Tidak bisa call ke nomor ini!')
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY GalladeBotz`);
});
}
} else reply(`Penggunaan spamsms nomor/reply pesan target*\nContoh spamsms +628991341381`)
...
mediaType:  1,
mediaUrl: 'https://wa.me/628991341381',
title: `GalladeBotz`,
sourceUrl: `https://wa.me/628991341381`, 
thumbnail: thumb
}
}})
}
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} GalladeBotz, 7, 7, 2005, Putri, 16, 11, 2004`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} GalladeBotz Hw`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} GalladeBotz, 7, 7, 2005`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} GalladeBotz|Putri`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} GalladeBotz, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} GalladeBotz, 7, 7, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
teksoooo = `│\n└────────────⭓\n\n*Total ada : ${docunye.length} \n\n Contoh 1 : sendpdf GalladeBotz + sambil reply pesan target* \n\n Contoh 2 : yopdf GalladeBotz`
m.reply(teksoooo)
}
break
//=================================================//
...
teksooooo = `│\n└────────────⭓\n\n*Total ada : ${zipnye.length} \n\n Contoh 1 : sendzip GalladeBotz + sambil reply pesan target* \n\n Contoh 2 : yozip GalladeBotz`
m.reply(teksooooo)
}
break
//=================================================//
...
teksoooooo = `│\n└────────────⭓\n\n*Total ada : ${apknye.length} \n\n Contoh 1 : sendapk GalladeBotz + sambil reply pesan target* \n\n Contoh 2 : yoapk GalladeBotz`
m.reply(teksoooooo)
}
break
//=================================================//
